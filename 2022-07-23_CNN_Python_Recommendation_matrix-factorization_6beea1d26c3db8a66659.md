<!--
title:   評価行列とアイテムの説明文書を活用した推薦システム「ConvMF」を何とか実装していきたい!③NLPにおけるCNNパートの実装
tags:    CNN,Python,QiitaEngineerFesta_深層学習,Recommendation,matrix-factorization
id:      6beea1d26c3db8a66659
private: false
-->
# 1. 参考
